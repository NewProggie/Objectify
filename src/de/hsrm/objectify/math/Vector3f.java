...
public class Vector3f {
	...
	/**
	 * Normalizes a vector and stores the result that is a vector in the same
	 * direction with length of 1 in pvret.
	 * 
	 * @param pv
	 *            Source vector.
	 * @param pvret
	...
	/**
	 * Normalizes a vector and returns the result that is a vector in the same
	 * direction with length of 1 as a new vector.
	 * 
	 * @param pv
	 *            The source vector.
	...
	/**
	 * Builds the cross product of two vectors an stores the result into pvret.
	 * 
	 * @param pv1
	 *            Left operand vector.
	 * @param pv2
	 ...
	 * 
	 * @param pv
	 *            The vector which is to rotate.
	 * @param pangle
	 *            The angle in rad of the rotation.
	 * @param pvret
	 *            The return vector.
	 */
	...
	/**
	 * The methods builds the normalized plane normal of the input vectors and
	 * stores the result into pvret. Note that this method uses the right hand
	 * rule. <br>
	 * </br>
	 * 
	 * @param pvec1
	...
	public static void normal(Vector3f pvec1, Vector3f pvec2, Vector3f pvec3,
		...
		//
		// Build the cross product to get the plane normal, and normalize the
		// vector.
		//
	...
	/**
	 * The methods builds the normalized plane normal of the input vectors and
	 * returns the result as a new vector. Note that this method uses the right
	 * hand rule. <br>
	 * </br>
	 * 
	 * @param pvec1
